...
def preprocess_image(image_path):
    ...
    preprocess = transforms.Compose([
        ...
        transforms.Resize((800, 800)),  # 根据模型输入大小调整
        transforms.ToTensor(),
...
def main(image_path, model_path, output_path):
    ...
    # 加载模型
    model = model_factory['bisenetv2'](19, aux_mode='eval')
...
if __name__ == "__main__":
    ...
    # model_path = "../res/model_own3_17_7801.pth"
    model_path = "../res/try4_3_79_25.pth"
