...
from .model_bloks_nores import bn_mom
from .model_bloks_nores import BatchNorm2d
from .model_bloks_nores import Res_basic
from .model_bloks_nores import Res_bottle
from .model_bloks_nores import Res_downsample
from .model_bloks_nores import DAPPM
from .model_bloks import DRM
...
class Liner_Risidual(nn.Module):
    def __init__(self, n_classes, aux_mode='train'):
        ...
        # self.s61 = Res_bottle(256, 256, 64, stride=2)
        ...
        if self.aux_mode == 'train':
            ...
            self.aux_loss = segmenthead(64, 128, n_classes, up_factor=8, aux=False)
